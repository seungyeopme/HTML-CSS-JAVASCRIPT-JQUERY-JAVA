...
/*
 ...
 paiza 버스에서 paica는 IC 카드를 승차권으로 사용할 수 있습니다. 사전에 paica에 충전을하여 사용할 수 있습니다.
...
당신이 먼저 충전 현금과 버스를 이용했을 때 걸린 요금의 목록이 주어지기 때문에 매번 내릴 때 남아있는 돈과 포인트를 출력합니다.
...
...
f_M
· 1 번째 줄에는 각각 소개 충전 된 금액 버스 승차 횟수를 나타내는 정수 N, M이이 순서로 공백으로 구분하여 부여됩니다.
· 계속 M 라인 중 i 번째 줄 (1 ≦ i ≦ M)는 i 번째 내릴 때 걸린 운임을 나타내는 정수 f_i가이 순서로 공백으로 구분하여 
  부여됩니다.
